    ...
    <PublicLayout>
      ...
      <section className="relative overflow-hidden bg-marine text-white">
        <div className="absolute inset-0 opacity-15">
          <Image src="/assets/water-flow-mobile.png" alt="" fill priority sizes="100vw" className="hero-water-motion object-cover md:hidden" />
          <Image src="/assets/water-flow-1.png" alt="" fill priority sizes="100vw" className="hero-water-motion hidden object-cover md:block" />
        </div>
